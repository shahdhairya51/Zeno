...
def wish_user():
    ...
    fun_talk("I am Zeno. Tell me how may I help you.")
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        if 'wikipedia' in query:
            ...
            os.startfile("C:\\Users\\DHAIRYA SHAH\\AppData\\Roaming\\Spotify\\Spotify.exe")

        elif 'open v l c' in query:
            os.startfile("C:\\Program Files\\VideoLAN\\VLC\\vlc.exe")

        elif 'who are you' in query:
            fun_talk("I am Zeno, developed by Dhairya Shah, Mokshit Gala , Riya Shah as a project in their college.")
        ...
        #     ec.capture.grab(0,"robo camera","img.jpg")
        ...
        elif 'quote' in query or 'sweet lines' in query:
        ...
        elif 'show me the note' in query or 'read notes' in query:
        ...
        #
            ...
            try:
                ...
                fun_talk('here are some top news from the times of india')
                print('''=============== TIMES OF INDIA ============''' + '\n')

                for item in data['articles']:
                    print(str(i) + '. ' + item['title'] + '\n')
                    print(item['description'] + '\n')
                    fun_talk(str(i) + '. ' + item['title'] + '\n')
                    i += 1
            except Exception as e:
